...
public class SystemNetUtils {
	...
	public static void main(String[] s) throws UnknownHostException {
		// System.out.println(SystemUtils.getHostAddress().getLocalHost().getHostAddress());
		// System.out.println(SystemUtils.getHostAddress().getLocalHost().getHostName());
		System.out.println(SystemNetUtils.getHostAddress().getLocalHost());
		// System.out.println(SystemUtils.getHostAddress().getHostAddress());
		// System.out.println(SystemUtils.getHostAddress().getHostName());
	}
}
